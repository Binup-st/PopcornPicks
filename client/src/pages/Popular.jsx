...
export default function Popular() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <p className="text-gray-400">Movies recently popular.</p>
      <div className="mt-5 flex flex-wrap justify-center">
        {movieDetails && movieDetails.length > 0 ? (
          movieDetails.map((movieDetail) => (
            <div key={movieDetail.id} className="flex">
              <Card
                className="w-52 m-2 custom-card transition-transform duration-300 transform perspective-1000 hover:scale-105 hover:drop-shadow-2xl"
